...
export const termLines: TermLine[] = [
  ...
  { type: "warn", text: "TASK-0011: v07r/v07f2 = FAIL → фикс v07f3 (0.0.13): удаление, чистый url, прозрачность ~25%, точка встречи=коммент" },
  { type: "arrow", text: "Б5: факт = репо пользователя · DONE только после хэша · содержимое выдано код-блоками" },
  { type: "cmd", text: "ожидание хэша коммита fix(ext): v07f2 [TASK-0011]_" },
];
