...
export const termLines: TermLine[] = [
  ...
  { type: "warn", text: "TASK-0011: v07r…v07f5 = FAIL → фикс v07f6 (0.0.16): метка на каждое вхождение, без предохранителей" },
  { type: "arrow", text: "Б5: факт = репо пользователя · DONE только после хэша · содержимое выдано код-блоками" },
  { type: "cmd", text: "ожидание хэша коммита fix(ext): v07f6 [TASK-0011]_" },
];
